              ...
              <Card profile plain className={classes.card3}>
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    <CardBody plain>
                      <h4 className={classes.cardTitle}>Armando Roque</h4>
                      <Muted>
                        <h6 className={classes.cardCategory}>CO FOUNDER - Frontend Developer</h6>
                      </Muted>
            ...
            <GridItem xs={12} sm={6} md={6}>
              <Card profile plain className={classes.card3}>
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    <CardBody plain>
                      <h4 className={classes.cardTitle}>Allan Torres</h4>
                      <Muted>
            ...
            <GridItem xs={12} sm={6} md={6}>
              <Card profile plain className={classes.card3}>
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    <CardBody plain>
                      <h4 className={classes.cardTitle}>Damian Nuñez</h4>
                      <Muted>
                        <h6 className={classes.cardCategory}>CO FOUNDER - Data Analyst</h6>
                      </Muted>
                      <p className={classes.description}>
            ...
            <GridItem xs={12} sm={6} md={6}>
              <Card profile plain className={classes.card3}>
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    <CardBody plain>
                      <h4 className={classes.cardTitle}>Javier Roque</h4>
                      <Muted>
                        <h6 className={classes.cardCategory}>CO FOUNDER - Backend Developer</h6>
                      </Muted>
                      <p className={classes.description}>
                        I love you like Kanye loves Kanye. Don't be scared of
                        the truth.
